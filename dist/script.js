...
/* harmony import */ var _slider__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./slider */ "./src/js/modules/slider/slider.js");
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    ...
    value: function init() {
      ...
      try {
        ...
        if (this.autoplay) {
          var autoPlaySlide = setInterval(function () {
            return _this3.nextSlider();
          }, 5000);
          [this.next, this.prev].concat(_toConsumableArray(this.slides)).forEach(function (btn) {
  ...
  return MiniSlider;
}(_slider__WEBPACK_IMPORTED_MODULE_12__["default"]);
